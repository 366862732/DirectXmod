...
extends RealmsScreen {
    ...
    public void init() {
        ...
        RealmsInviteScreen realmsInviteScreen = this;
        this.layout.visitWidgets(x$0 -> realmsInviteScreen.addRenderableWidget(x$0));
    ...
    private void onInvite() {
        ...
        if (this.serverData.players.stream().anyMatch(player -> player.name.equalsIgnoreCase(this.profileName.getValue()))) {
