...
extends RealmsScreen {
    ...
    extends ObjectSelectionList.Entry<Entry> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
            ...
            graphics.text(this.this$0.font, this.template.name(), textX, textY, -1);
            graphics.text(this.this$0.font, this.template.version(), this.getContentRight() - versionTextWidth - 5, textY, -6250336);
            graphics.text(this.this$0.font, this.template.author(), textX, textY + ((RealmsSelectWorldTemplateScreen)this.this$0).font.lineHeight + 5, -6250336);
            if (!this.template.recommendedPlayers().isBlank()) {
                graphics.text(this.this$0.font, this.template.recommendedPlayers(), textX, this.getContentBottom() - ((RealmsSelectWorldTemplateScreen)this.this$0).font.lineHeight / 2 - 5, -8355712);
            }
        }
