...
public class RideCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("ride").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS))).then(((RequiredArgumentBuilder)Commands.argument("target", EntityArgument.entity()).then(Commands.literal("mount").then(Commands.argument("vehicle", EntityArgument.entity()).executes(c -> RideCommand.mount((CommandSourceStack)c.getSource(), EntityArgument.getEntity((CommandContext<CommandSourceStack>)c, "target"), EntityArgument.getEntity((CommandContext<CommandSourceStack>)c, "vehicle")))))).then(Commands.literal("dismount").executes(c -> RideCommand.dismount((CommandSourceStack)c.getSource(), EntityArgument.getEntity((CommandContext<CommandSourceStack>)c, "target"))))));
    }
    ...
    private static int mount(CommandSourceStack source, Entity target, Entity vehicle) throws CommandSyntaxException {
        ...
        if (currentVehicle != null) {
            throw ERROR_ALREADY_RIDING.create((Object)target.getDisplayName(), (Object)currentVehicle.getDisplayName());
        }
        ...
        if (!target.startRiding(vehicle, true, true)) {
            throw ERROR_MOUNT_FAILED.create((Object)target.getDisplayName(), (Object)vehicle.getDisplayName());
        }
