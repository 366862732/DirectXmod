...
public class VanillaBlockItemTagsProvider
extends BlockItemTagsProvider {
    protected VanillaBlockItemTagsProvider(Function<BlockItemTagId, BlockItemTagsProvider.CombinedAppender> tagSupplier) {
        super(tagSupplier);
    }
