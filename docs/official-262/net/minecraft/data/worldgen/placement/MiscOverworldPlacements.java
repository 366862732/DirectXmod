...
public class MiscOverworldPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> iceSpike = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICE_SPIKE);
        Holder.Reference<ConfiguredFeature<?, ?>> icePatch = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICE_PATCH);
        Holder.Reference<ConfiguredFeature<?, ?>> forestRock = configuredFeatures.getOrThrow(MiscOverworldFeatures.FOREST_ROCK);
        Holder.Reference<ConfiguredFeature<?, ?>> icebergPacked = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICEBERG_PACKED);
        Holder.Reference<ConfiguredFeature<?, ?>> icebergBlue = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICEBERG_BLUE);
        Holder.Reference<ConfiguredFeature<?, ?>> blueIce = configuredFeatures.getOrThrow(MiscOverworldFeatures.BLUE_ICE);
        Holder.Reference<ConfiguredFeature<?, ?>> lakeLava = configuredFeatures.getOrThrow(MiscOverworldFeatures.LAKE_LAVA);
        Holder.Reference<ConfiguredFeature<?, ?>> sulfurPool = configuredFeatures.getOrThrow(MiscOverworldFeatures.SULFUR_POOL);
        Holder.Reference<ConfiguredFeature<?, ?>> diskClay = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_CLAY);
        Holder.Reference<ConfiguredFeature<?, ?>> diskGravel = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_GRAVEL);
        Holder.Reference<ConfiguredFeature<?, ?>> diskSand = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_SAND);
        Holder.Reference<ConfiguredFeature<?, ?>> diskGrass = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_GRASS);
        Holder.Reference<ConfiguredFeature<?, ?>> freezeTopLayer = configuredFeatures.getOrThrow(MiscOverworldFeatures.FREEZE_TOP_LAYER);
        Holder.Reference<ConfiguredFeature<?, ?>> voidStartPlatform = configuredFeatures.getOrThrow(MiscOverworldFeatures.VOID_START_PLATFORM);
        Holder.Reference<ConfiguredFeature<?, ?>> desertWell = configuredFeatures.getOrThrow(MiscOverworldFeatures.DESERT_WELL);
        Holder.Reference<ConfiguredFeature<?, ?>> springLavaOverworld = configuredFeatures.getOrThrow(MiscOverworldFeatures.SPRING_LAVA_OVERWORLD);
        Holder.Reference<ConfiguredFeature<?, ?>> springLavaFrozen = configuredFeatures.getOrThrow(MiscOverworldFeatures.SPRING_LAVA_FROZEN);
        Holder.Reference<ConfiguredFeature<?, ?>> springWater = configuredFeatures.getOrThrow(MiscOverworldFeatures.SPRING_WATER);
