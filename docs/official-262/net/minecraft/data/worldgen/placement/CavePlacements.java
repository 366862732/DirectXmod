...
public class CavePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> monsterRoom = configuredFeatures.getOrThrow(CaveFeatures.MONSTER_ROOM);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> sulfurSpikeCluster = configuredFeatures.getOrThrow(CaveFeatures.SULFUR_SPIKE_CLUSTER);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> sulfurSpike = configuredFeatures.getOrThrow(CaveFeatures.SULFUR_SPIKE);
        ...
        Holder.Reference<ConfiguredFeature<?, ?>> rootedSulfurSpring = configuredFeatures.getOrThrow(CaveFeatures.ROOTED_SULFUR_SPRING);
