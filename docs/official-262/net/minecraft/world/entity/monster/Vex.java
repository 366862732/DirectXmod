...
OwnableEntity {
    ...
    public Vex(EntityType<? extends Vex> type, Level level) {
        ...
        this.moveControl = new VexMoveControl(this, (Mob)this);
        this.xpReward = 3;
    }
    ...
    private class VexMoveControl<T extends Mob>
    extends MoveControl<T> {
        final /* synthetic */ Vex this$0;

        public VexMoveControl(T vex) {
            reference v0 = var1_1;
    ...
    extends TargetGoal {
        ...
        public boolean canUse() {
            Targeting owner;
            LivingEntity livingEntity = this.this$0.getOwner();
            return livingEntity instanceof Targeting && (owner = (Targeting)((Object)livingEntity)).getTarget() != null && this.canAttack(owner.getTarget(), this.copyOwnerTargeting);
        }

        @Override
        public void start() {
            LivingEntity livingEntity;
            LivingEntity livingEntity2 = this.this$0.getOwner();
            if (livingEntity2 instanceof Targeting) {
                Targeting owner = (Targeting)((Object)livingEntity2);
                livingEntity = owner.getTarget();
            } else {
                livingEntity = null;
            }
            this.this$0.setTarget(livingEntity);
            super.start();
        }
    }
}
