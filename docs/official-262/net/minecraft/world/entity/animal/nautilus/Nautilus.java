...
extends AbstractNautilus {
    ...
    private static final EntityDimensions BABY_DIMENSIONS = EntityTypes.NAUTILUS.getDimensions().scale(0.5f).withAttachments(EntityAttachments.builder().attach(EntityAttachment.PASSENGER, 0.0f, 0.5f, 0.0f));
    ...
    public @Nullable Nautilus getBreedOffspring(ServerLevel level, AgeableMob partner) {
        Nautilus baby = EntityTypes.NAUTILUS.create((Level)level, EntitySpawnReason.BREEDING);
