...
public class Attributes {
    ...
    public static final Holder<Attribute> AIR_DRAG_MODIFIER = Attributes.register("air_drag_modifier", new RangedAttribute("attribute.name.air_drag_modifier", 1.0, 0.0, 2048.0).setSyncable(true));
    ...
    public static final Holder<Attribute> BELOW_NAME_DISTANCE = Attributes.register("below_name_distance", new RangedAttribute("attribute.name.below_name_distance", 10.0, 0.0, 512.0).setSyncable(true));
    ...
    public static final Holder<Attribute> BOUNCINESS = Attributes.register("bounciness", new RangedAttribute("attribute.name.bounciness", 0.0, 0.0, 1.0).setSyncable(true));
    ...
    public static final Holder<Attribute> FRICTION_MODIFIER = Attributes.register("friction_modifier", new RangedAttribute("attribute.name.friction_modifier", 1.0, 0.0, 2048.0).setSyncable(true));
    ...
    public static final Holder<Attribute> KNOCKBACK_RESISTANCE = Attributes.register("knockback_resistance", new RangedAttribute("attribute.name.knockback_resistance", 0.0, -2.0, 1.0));
    ...
    public static final Holder<Attribute> NAME_TAG_DISTANCE = Attributes.register("name_tag_distance", new RangedAttribute("attribute.name.name_tag_distance", 64.0, 0.0, 512.0).setSyncable(true));
