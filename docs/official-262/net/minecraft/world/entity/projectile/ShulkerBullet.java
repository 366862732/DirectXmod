...
extends Projectile {
    ...
    public ShulkerBullet(Level level, LivingEntity owner, Entity target, Direction.Axis invalidStartAxis) {
        this((EntityType<? extends ShulkerBullet>)EntityTypes.SHULKER_BULLET, level);
        this.setOwner(owner);
    ...
    protected void onHitEntity(EntityHitResult hitResult) {
        ...
        LivingEntity livingOwner = owner instanceof LivingEntity ? (livingEntity = (LivingEntity)owner) : null;
