...
public interface StructurePieceType {
    ...
    public static final StructurePieceType OCEAN_RUIN = StructurePieceType.setTemplatePieceId(OceanRuinPieces.OceanRuinPiece::create, "ORP");
    public static final StructurePieceType IGLOO = StructurePieceType.setTemplatePieceId(IglooPieces.IglooPiece::new, "Iglu");
    public static final StructurePieceType RUINED_PORTAL = StructurePieceType.setFullContextPieceId(RuinedPortalPiece::new, "RUPO");
    ...
    private static StructurePieceType setPieceId(ContextlessType type, String id) {
        return StructurePieceType.setFullContextPieceId(type, id);
    }

    private static StructurePieceType setTemplatePieceId(StructureTemplateType type, String id) {
        return StructurePieceType.setFullContextPieceId(type, id);
    }
    ...
    extends StructurePieceType {
        ...
        @Override
        default public StructurePiece load(StructurePieceSerializationContext context, CompoundTag tag) {
