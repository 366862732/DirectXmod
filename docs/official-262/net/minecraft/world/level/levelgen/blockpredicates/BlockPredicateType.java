...
public interface BlockPredicateType<P extends BlockPredicate> {
    ...
    public static final BlockPredicateType<MatchingBiomesPredicate> MATCHING_BIOMES = BlockPredicateType.register("matching_biomes", MatchingBiomesPredicate.CODEC);
