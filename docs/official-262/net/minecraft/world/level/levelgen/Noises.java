...
public class Noises {
    ...
    public static final ResourceKey<NormalNoise.NoiseParameters> TEMPERATURE_NETHER = Noises.createKey("nether/temperature");
    public static final ResourceKey<NormalNoise.NoiseParameters> VEGETATION_NETHER = Noises.createKey("nether/vegetation");
    ...
    public static final ResourceKey<NormalNoise.NoiseParameters> SULFUR_CAVE_GRADIENT = Noises.createKey("sulfur_cave_gradient");
    ...
    public static NormalNoise instantiate(HolderGetter<NormalNoise.NoiseParameters> noises, PositionalRandomFactory context, ResourceKey<NormalNoise.NoiseParameters> name) {
        ...
        return NormalNoise.create(context.fromHashOf(name.identifier()), (NormalNoise.NoiseParameters)holder.value());
    }
}
