...
public class BlockStateProperties {
    ...
    public static final EnumProperty<Direction> FACING = EnumProperty.create((String)"facing", Direction.class, (Enum[])new Direction[]{Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN});
    ...
    public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, railShape -> railShape != RailShape.NORTH_EAST && railShape != RailShape.NORTH_WEST && railShape != RailShape.SOUTH_EAST && railShape != RailShape.SOUTH_WEST);
    ...
    public static final EnumProperty<Direction> VERTICAL_DIRECTION = EnumProperty.create((String)"vertical_direction", Direction.class, (Enum[])new Direction[]{Direction.UP, Direction.DOWN});
