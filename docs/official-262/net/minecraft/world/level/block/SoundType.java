...
public class SoundType {
    ...
    public static final SoundType SULFUR = new SoundType(1.0f, 1.0f, SoundEvents.SULFUR_BREAK, SoundEvents.SULFUR_STEP, SoundEvents.SULFUR_PLACE, SoundEvents.SULFUR_HIT, SoundEvents.SULFUR_FALL);
    public static final SoundType POTENT_SULFUR = new SoundType(1.0f, 1.0f, SoundEvents.POTENT_SULFUR_BREAK, SoundEvents.POTENT_SULFUR_STEP, SoundEvents.POTENT_SULFUR_PLACE, SoundEvents.POTENT_SULFUR_HIT, SoundEvents.POTENT_SULFUR_FALL);
    public static final SoundType SULFUR_SPIKE = new SoundType(1.0f, 1.0f, SoundEvents.SULFUR_SPIKE_BREAK, SoundEvents.SULFUR_SPIKE_STEP, SoundEvents.SULFUR_SPIKE_PLACE, SoundEvents.SULFUR_SPIKE_HIT, SoundEvents.SULFUR_SPIKE_FALL);
    public static final SoundType CINNABAR = new SoundType(1.0f, 1.0f, SoundEvents.CINNABAR_BREAK, SoundEvents.CINNABAR_STEP, SoundEvents.CINNABAR_PLACE, SoundEvents.CINNABAR_HIT, SoundEvents.CINNABAR_FALL);
