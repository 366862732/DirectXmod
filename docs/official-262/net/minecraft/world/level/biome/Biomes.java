...
public abstract class Biomes {
    ...
    public static final ResourceKey<Biome> PALE_GARDEN = Biomes.register("pale_garden");
    ...
    public static final ResourceKey<Biome> SULFUR_CAVES = Biomes.register("sulfur_caves");
