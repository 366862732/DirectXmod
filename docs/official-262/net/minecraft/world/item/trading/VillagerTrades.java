...
public class VillagerTrades {
    ...
    public static final ColorCollection<ResourceKey<VillagerTrade>> SHEPHERD_2_EMERALD_WOOL = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("shepherd/2/emerald_" + color + "_wool"));
    public static final ColorCollection<ResourceKey<VillagerTrade>> SHEPHERD_2_EMERALD_CARPETS = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("shepherd/2/emerald_" + color + "_carpet"));
    ...
    public static final ColorCollection<ResourceKey<VillagerTrade>> SHEPHERD_3_EMERALD_BED = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("shepherd/3/emerald_" + color + "_bed"));
    ...
    public static final ColorCollection<ResourceKey<VillagerTrade>> SHEPHERD_4_EMERALD_BANNER = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("shepherd/4/emerald_" + color + "_banner"));
    ...
    public static final ResourceKey<VillagerTrade> FLETCHER_1_GRAVEL_AND_EMERALD_FLINT = VillagerTrades.resourceKey("fletcher/1/gravel_and_emerald_flint");
    ...
    public static final ColorCollection<ResourceKey<VillagerTrade>> MASON_4_EMERALD_TERRACOTTA = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("mason/4/emerald_" + color + "_terracotta"));
    public static final ColorCollection<ResourceKey<VillagerTrade>> MASON_4_EMERALD_GLAZED_TERRACOTTA = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("mason/4/emerald_" + color + "_glazed_terracotta"));
    ...
    public static final ColorCollection<ResourceKey<VillagerTrade>> WANDERING_TRADER_EMERALD_DYE = ColorCollection.NAMES.map(color -> VillagerTrades.resourceKey("wandering_trader/emerald_" + color + "_dye"));
    ...
    public static final ResourceKey<VillagerTrade> WANDERING_TRADER_EMERALD_SULFUR_SPIKE = VillagerTrades.resourceKey("wandering_trader/emerald_sulfur_spike");
    ...
    public static Holder<VillagerTrade> bootstrap(BootstrapContext<VillagerTrade> context) {
        ...
        HolderSet.Named<Enchantment> enchantmentsForTradedEquipment = enchantments.getOrThrow(EnchantmentTags.ON_TRADED_EQUIPMENT);
        HolderSet.Named<Enchantment> enchantmentsForBooks = enchantments.getOrThrow(EnchantmentTags.TRADEABLE);
        HolderSet.Named<Enchantment> doubleTradePrice = enchantments.getOrThrow(EnchantmentTags.DOUBLE_TRADE_PRICE);
        HolderGetter<Potion> potions = context.lookup(Registries.POTION);
        HolderSet.Named<Potion> potionsForTippedArrows = potions.getOrThrow(PotionTags.TRADEABLE);
        ...
        VillagerTrades.register(context, FISHERMAN_2_EMERALD_CAMPFIRE, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 2), new ItemStackTemplate(Items.CAMPFIRE), 12, 5, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.registerShepherdWoolSales(context);
        ...
        VillagerTrades.registerShepherdLevelTwoDyeTrades(context);
        VillagerTrades.registerWoolPurchases(context);
        VillagerTrades.registerCarpetPurchases(context);
        VillagerTrades.registerShepherdLevelThreeDyeTrades(context);
        ...
        VillagerTrades.register(context, FLETCHER_1_EMERALD_ARROW, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(Items.ARROW, 16), 12, 1, 0.05f, Optional.empty(), List.of()));
        VillagerTrades.register(context, FLETCHER_1_GRAVEL_AND_EMERALD_FLINT, new VillagerTrade(new TradeCost((ItemLike)Items.GRAVEL, 10), Optional.of(new TradeCost((ItemLike)Items.EMERALD, 1)), new ItemStackTemplate(Items.FLINT, 10), 12, 1, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.register(context, FLETCHER_5_ARROW_AND_EMERALD_TIPPED_ARROW, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 2), Optional.of(new TradeCost((ItemLike)Items.ARROW, 5)), new ItemStackTemplate(Items.TIPPED_ARROW, 5), 12, 30, 0.05f, Optional.empty(), List.of(SetRandomPotionFunction.fromTagKey(potionsForTippedArrows).build())));
        ...
        VillagerTrades.register(context, LIBRARIAN_5_EMERALD_YELLOW_CANDLE, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate(Items.DYED_CANDLE.yellow()), 12, 30, 0.05f, Optional.empty(), List.of()));
        VillagerTrades.register(context, LIBRARIAN_5_EMERALD_RED_CANDLE, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate(Items.DYED_CANDLE.red()), 12, 30, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.register(context, CARTOGRAPHER_3_EMERALD_AND_COMPASS_OCEAN_EXPLORER_MAP, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 13), Optional.of(new TradeCost((ItemLike)Items.COMPASS, 1)), new ItemStackTemplate(Items.MAP), 12, 10, 0.2f, Optional.empty(), List.of(ExplorationMapFunction.makeExplorationMap().setDestination(StructureTags.ON_OCEAN_EXPLORER_MAPS).setMapDecoration(MapDecorationTypes.OCEAN_MONUMENT).setSearchRadius(100).setSkipKnownStructures(true).build(), SetNameFunction.setName(Component.translatable("filled_map.monument"), SetNameFunction.Target.ITEM_NAME).build(), FilteredFunction.filtered(new ItemPredicate.Builder().of(items, Items.FILLED_MAP).withComponents(DataComponentMatchers.Builder.components().any(DataComponents.MAP_ID).build()).build()).onFail(Optional.of(DiscardItem.discardItem().build())).build())));
        VillagerTrades.register(context, CARTOGRAPHER_3_EMERALD_AND_COMPASS_TRIAL_CHAMBER_MAP, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 12), Optional.of(new TradeCost((ItemLike)Items.COMPASS, 1)), new ItemStackTemplate(Items.MAP), 12, 10, 0.2f, Optional.empty(), List.of(ExplorationMapFunction.makeExplorationMap().setDestination(StructureTags.ON_TRIAL_CHAMBERS_MAPS).setMapDecoration(MapDecorationTypes.TRIAL_CHAMBERS).setSearchRadius(100).setSkipKnownStructures(true).build(), SetNameFunction.setName(Component.translatable("filled_map.trial_chambers"), SetNameFunction.Target.ITEM_NAME).build(), FilteredFunction.filtered(new ItemPredicate.Builder().of(items, Items.FILLED_MAP).withComponents(DataComponentMatchers.Builder.components().any(DataComponents.MAP_ID).build()).build()).onFail(Optional.of(DiscardItem.discardItem().build())).build())));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_ITEM_FRAME, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 7), new ItemStackTemplate(Items.ITEM_FRAME), 12, 15, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.register(context, WEAPONSMITH_1_EMERALD_ENCHANTED_IRON_SWORD, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 2), new ItemStackTemplate(Items.IRON_SWORD), 12, 1, 0.2f, Optional.empty(), VillagerTrades.enchantedItem(items, enchantmentsForTradedEquipment, Items.IRON_SWORD)));
        ...
        VillagerTrades.register(context, WEAPONSMITH_4_DIAMOND_EMERALD, new VillagerTrade(new TradeCost((ItemLike)Items.DIAMOND, 1), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.register(context, TOOLSMITH_4_DIAMOND_EMERALD, new VillagerTrade(new TradeCost((ItemLike)Items.DIAMOND, 1), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.register(context, BUTCHER_1_EMERALD_RABBIT_STEW, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(Items.RABBIT_STEW), 12, 1, 0.05f, Optional.empty(), List.of()));
        ...
        VillagerTrades.register(context, LEATHERWORKER_1_EMERALD_DYED_LEATHER_LEGGINGS, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate(Items.LEATHER_LEGGINGS), 12, 1, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_LEGGINGS)));
        VillagerTrades.register(context, LEATHERWORKER_1_EMERALD_DYED_LEATHER_CHESTPLATE, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 7), new ItemStackTemplate(Items.LEATHER_CHESTPLATE), 12, 1, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_CHESTPLATE)));
        ...
        VillagerTrades.register(context, LEATHERWORKER_2_EMERALD_DYED_LEATHER_HELMET, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 5), new ItemStackTemplate(Items.LEATHER_HELMET), 12, 5, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_HELMET)));
        VillagerTrades.register(context, LEATHERWORKER_2_EMERALD_DYED_LEATHER_BOOTS, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 4), new ItemStackTemplate(Items.LEATHER_BOOTS), 12, 5, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_BOOTS)));
        ...
        VillagerTrades.register(context, LEATHERWORKER_3_EMERALD_DYED_LEATHER_CHESTPLATE, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 7), new ItemStackTemplate(Items.LEATHER_CHESTPLATE), 12, 1, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_CHESTPLATE)));
        ...
        VillagerTrades.register(context, LEATHERWORKER_4_EMERALD_DYED_LEATHER_HORSE_ARMOR, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 6), new ItemStackTemplate(Items.LEATHER_HORSE_ARMOR), 12, 15, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_HORSE_ARMOR)));
        ...
        VillagerTrades.register(context, LEATHERWORKER_5_EMERALD_DYED_LEATHER_HELMET, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 5), new ItemStackTemplate(Items.LEATHER_HELMET), 12, 5, 0.2f, Optional.empty(), VillagerTrades.dyedItem(items, Items.LEATHER_HELMET)));
        ...
        VillagerTrades.register(context, MASON_4_QUARTZ_EMERALD, new VillagerTrade(new TradeCost((ItemLike)Items.QUARTZ, 12), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05f, Optional.empty(), List.of()));
        ...
        context.register(WANDERING_TRADER_BAKED_POTATO_EMERALD, new VillagerTrade(new TradeCost((ItemLike)Items.BAKED_POTATO, 4), new ItemStackTemplate(Items.EMERALD, 1), 2, 1, 0.05f, Optional.empty(), List.of()));
        ...
        context.register(WANDERING_TRADER_EMERALD_ACACIA_LOG, VillagerTrades.createWanderingTraderLogSell(Items.ACACIA_LOG));
        context.register(WANDERING_TRADER_EMERALD_BIRCH_LOG, VillagerTrades.createWanderingTraderLogSell(Items.BIRCH_LOG));
        context.register(WANDERING_TRADER_EMERALD_DARK_OAK_LOG, VillagerTrades.createWanderingTraderLogSell(Items.DARK_OAK_LOG));
        context.register(WANDERING_TRADER_EMERALD_JUNGLE_LOG, VillagerTrades.createWanderingTraderLogSell(Items.JUNGLE_LOG));
        context.register(WANDERING_TRADER_EMERALD_OAK_LOG, VillagerTrades.createWanderingTraderLogSell(Items.OAK_LOG));
        context.register(WANDERING_TRADER_EMERALD_SPRUCE_LOG, VillagerTrades.createWanderingTraderLogSell(Items.SPRUCE_LOG));
        context.register(WANDERING_TRADER_EMERALD_CHERRY_LOG, VillagerTrades.createWanderingTraderLogSell(Items.CHERRY_LOG));
        context.register(WANDERING_TRADER_EMERALD_MANGROVE_LOG, VillagerTrades.createWanderingTraderLogSell(Items.MANGROVE_LOG));
        context.register(WANDERING_TRADER_EMERALD_PALE_OAK_LOG, VillagerTrades.createWanderingTraderLogSell(Items.PALE_OAK_LOG));
        ...
        context.register(WANDERING_TRADER_EMERALD_BRAIN_CORAL_BLOCK, VillagerTrades.createWanderingTraderCoralBlockSell(Items.BRAIN_CORAL_BLOCK));
        context.register(WANDERING_TRADER_EMERALD_BUBBLE_CORAL_BLOCK, VillagerTrades.createWanderingTraderCoralBlockSell(Items.BUBBLE_CORAL_BLOCK));
        context.register(WANDERING_TRADER_EMERALD_FIRE_CORAL_BLOCK, VillagerTrades.createWanderingTraderCoralBlockSell(Items.FIRE_CORAL_BLOCK));
        context.register(WANDERING_TRADER_EMERALD_HORN_CORAL_BLOCK, VillagerTrades.createWanderingTraderCoralBlockSell(Items.HORN_CORAL_BLOCK));
        context.register(WANDERING_TRADER_EMERALD_TUBE_CORAL_BLOCK, VillagerTrades.createWanderingTraderCoralBlockSell(Items.TUBE_CORAL_BLOCK));
        ...
        context.register(WANDERING_TRADER_EMERALD_SULFUR_SPIKE, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(Items.SULFUR_SPIKE, 2), 5, 1, 0.05f, Optional.empty(), List.of()));
    ...
    private static VillagerTrade createWanderingTraderCoralBlockSell(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate(item), 8, 1, 0.05f, Optional.empty(), List.of());
    }

    private static VillagerTrade createWanderingTraderLogSell(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(item, 8), 4, 1, 0.05f, Optional.empty(), List.of());
    }

    private static void registerWanderingTraderFlowers(BootstrapContext<VillagerTrade> context) {
        context.register(WANDERING_TRADER_EMERALD_BLUE_ORCHID, VillagerTrades.createWanderingTraderFlowerSell(Items.BLUE_ORCHID, 8));
        context.register(WANDERING_TRADER_EMERALD_DANDELION, VillagerTrades.createWanderingTraderFlowerSell(Items.DANDELION, 12));
        context.register(WANDERING_TRADER_EMERALD_POPPY, VillagerTrades.createWanderingTraderFlowerSell(Items.POPPY, 12));
        context.register(WANDERING_TRADER_EMERALD_ALLIUM, VillagerTrades.createWanderingTraderFlowerSell(Items.ALLIUM, 12));
        context.register(WANDERING_TRADER_EMERALD_AZURE_BLUET, VillagerTrades.createWanderingTraderFlowerSell(Items.AZURE_BLUET, 12));
        context.register(WANDERING_TRADER_EMERALD_RED_TULIP, VillagerTrades.createWanderingTraderFlowerSell(Items.RED_TULIP, 12));
        context.register(WANDERING_TRADER_EMERALD_ORANGE_TULIP, VillagerTrades.createWanderingTraderFlowerSell(Items.ORANGE_TULIP, 12));
        context.register(WANDERING_TRADER_EMERALD_WHITE_TULIP, VillagerTrades.createWanderingTraderFlowerSell(Items.WHITE_TULIP, 12));
        context.register(WANDERING_TRADER_EMERALD_PINK_TULIP, VillagerTrades.createWanderingTraderFlowerSell(Items.PINK_TULIP, 12));
        context.register(WANDERING_TRADER_EMERALD_OXEYE_DAISY, VillagerTrades.createWanderingTraderFlowerSell(Items.OXEYE_DAISY, 12));
        context.register(WANDERING_TRADER_EMERALD_CORNFLOWER, VillagerTrades.createWanderingTraderFlowerSell(Items.CORNFLOWER, 12));
        context.register(WANDERING_TRADER_EMERALD_WILDFLOWERS, VillagerTrades.createWanderingTraderFlowerSell(Items.WILDFLOWERS, 12));
        context.register(WANDERING_TRADER_EMERALD_DRY_TALL_GRASS, VillagerTrades.createWanderingTraderFlowerSell(Items.DRY_TALL_GRASS, 12));
        context.register(WANDERING_TRADER_EMERALD_LILY_OF_THE_VALLEY, VillagerTrades.createWanderingTraderFlowerSell(Items.LILY_OF_THE_VALLEY, 7));
        context.register(WANDERING_TRADER_EMERALD_OPEN_EYEBLOSSOM, VillagerTrades.createWanderingTraderFlowerSell(Items.OPEN_EYEBLOSSOM, 7));
    ...
    private static VillagerTrade createWanderingTraderFlowerSell(Item item, int maxUses) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(item), maxUses, 1, 0.05f, Optional.empty(), List.of());
    }

    private static void registerWanderingTraderSeeds(BootstrapContext<VillagerTrade> context) {
        context.register(WANDERING_TRADER_EMERALD_WHEAT_SEEDS, VillagerTrades.createWanderingTraderSeedSell(Items.WHEAT_SEEDS));
        context.register(WANDERING_TRADER_EMERALD_BEETROOT_SEEDS, VillagerTrades.createWanderingTraderSeedSell(Items.BEETROOT_SEEDS));
        context.register(WANDERING_TRADER_EMERALD_PUMPKIN_SEEDS, VillagerTrades.createWanderingTraderSeedSell(Items.PUMPKIN_SEEDS));
        context.register(WANDERING_TRADER_EMERALD_MELON_SEEDS, VillagerTrades.createWanderingTraderSeedSell(Items.MELON_SEEDS));
    }

    private static VillagerTrade createWanderingTraderSeedSell(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(item), 12, 1, 0.05f, Optional.empty(), List.of());
    }

    private static void registerWanderingTraderSaplings(BootstrapContext<VillagerTrade> context) {
        context.register(WANDERING_TRADER_EMERALD_ACACIA_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.ACACIA_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_BIRCH_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.BIRCH_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_DARK_OAK_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.DARK_OAK_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_JUNGLE_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.JUNGLE_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_OAK_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.OAK_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_SPRUCE_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.SPRUCE_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_CHERRY_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.CHERRY_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_PALE_OAK_SAPLING, VillagerTrades.createWanderingTraderSaplingSell(Items.PALE_OAK_SAPLING));
        context.register(WANDERING_TRADER_EMERALD_MANGROVE_PROPAGULE, VillagerTrades.createWanderingTraderSaplingSell(Items.MANGROVE_PROPAGULE));
    }

    private static VillagerTrade createWanderingTraderSaplingSell(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 5), new ItemStackTemplate(item), 8, 1, 0.05f, Optional.empty(), List.of());
    }

    private static void registerWanderingTraderDyes(BootstrapContext<VillagerTrade> context) {
        ColorCollection.zipApply(WANDERING_TRADER_EMERALD_DYE, Items.DYE, (name, dye) -> context.register((ResourceKey<VillagerTrade>)name, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate((Item)dye, 3), 12, 1, 0.05f, Optional.empty(), List.of())));
    }

    private static void registerMasonLevelFourTerracotta(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.registerWanderingTraderTerracottaSellTrades(context, MASON_4_EMERALD_TERRACOTTA, Items.DYED_TERRACOTTA);
        VillagerTrades.registerWanderingTraderTerracottaSellTrades(context, MASON_4_EMERALD_GLAZED_TERRACOTTA, Items.GLAZED_TERRACOTTA);
    }
    ...
    private static void registerWanderingTraderTerracottaSellTrades(BootstrapContext<VillagerTrade> context, ColorCollection<ResourceKey<VillagerTrade>> trades, ColorCollection<Item> items) {
        ColorCollection.zipApply(trades, items, (trade, item) -> VillagerTrades.register(context, trade, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate((Item)item), 12, 15, 0.05f, Optional.empty(), List.of())));
    }

    private static void registerMasonLevelThreeBlocks(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.register(context, MASON_3_EMERALD_DRIPSTONE_BLOCK, VillagerTrades.createMasonStoneSell(Items.DRIPSTONE_BLOCK));
        VillagerTrades.register(context, MASON_3_EMERALD_POLISHED_ANDESITE, VillagerTrades.createMasonStoneSell(Items.POLISHED_ANDESITE));
        VillagerTrades.register(context, MASON_3_EMERALD_POLISHED_DIORITE, VillagerTrades.createMasonStoneSell(Items.POLISHED_DIORITE));
        VillagerTrades.register(context, MASON_3_EMERALD_POLISHED_GRANTITE, VillagerTrades.createMasonStoneSell(Items.POLISHED_GRANITE));
    }

    private static VillagerTrade createMasonStoneSell(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate(item, 4), 16, 10, 0.05f, Optional.empty(), List.of());
    }

    private static void registerMasonLevelThreeStones(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.register(context, MASON_3_GRANITE_EMERALD, VillagerTrades.createMasonStoneBuy(Items.GRANITE));
        VillagerTrades.register(context, MASON_3_ANDESITE_EMERALD, VillagerTrades.createMasonStoneBuy(Items.ANDESITE));
        VillagerTrades.register(context, MASON_3_DIORITE_EMERALD, VillagerTrades.createMasonStoneBuy(Items.DIORITE));
    }

    private static VillagerTrade createMasonStoneBuy(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)item, 16), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05f, Optional.empty(), List.of());
    }

    private static void registerBoatTrades(BootstrapContext<VillagerTrade> context, HolderGetter<VillagerType> villagerVariants) {
        VillagerTrades.register(context, FISHERMAN_5_OAK_BOAT_EMERALD, VillagerTrades.createMasonBoatBuyTrade(villagerVariants, Items.OAK_BOAT, List.of(VillagerType.PLAINS)));
        VillagerTrades.register(context, FISHERMAN_5_SPRUCE_BOAT_EMERALD, VillagerTrades.createMasonBoatBuyTrade(villagerVariants, Items.SPRUCE_BOAT, List.of(VillagerType.TAIGA, VillagerType.SNOW)));
        VillagerTrades.register(context, FISHERMAN_5_JUNGLE_BOAT_EMERALD, VillagerTrades.createMasonBoatBuyTrade(villagerVariants, Items.JUNGLE_BOAT, List.of(VillagerType.DESERT, VillagerType.JUNGLE)));
        VillagerTrades.register(context, FISHERMAN_5_ACACIA_BOAT_EMERALD, VillagerTrades.createMasonBoatBuyTrade(villagerVariants, Items.ACACIA_BOAT, List.of(VillagerType.SAVANNA)));
        VillagerTrades.register(context, FISHERMAN_5_DARK_OAK_BOAT_EMERALD, VillagerTrades.createMasonBoatBuyTrade(villagerVariants, Items.DARK_OAK_BOAT, List.of(VillagerType.SWAMP)));
    }
    ...
    private static VillagerTrade createMasonBoatBuyTrade(HolderGetter<VillagerType> villagerVariants, Item item, List<ResourceKey<VillagerType>> villagerTypes) {
        return new VillagerTrade(new TradeCost((ItemLike)item, 1), new ItemStackTemplate(Items.EMERALD), 12, 30, 0.05f, VillagerTrades.villagerTypeRestriction(VillagerTrades.villagerTypeHolderSet(villagerVariants, villagerTypes)), List.of());
    }

    private static void registerShepherdWoolSales(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.register(context, SHEPHERD_1_WHITE_WOOL_EMERALD, VillagerTrades.createShepherdWoolBuy(Items.WOOL.white()));
        VillagerTrades.register(context, SHEPHERD_1_BROWN_WOOL_EMERALD, VillagerTrades.createShepherdWoolBuy(Items.WOOL.brown()));
        VillagerTrades.register(context, SHEPHERD_1_GRAY_WOOL_EMERALD, VillagerTrades.createShepherdWoolBuy(Items.WOOL.gray()));
        VillagerTrades.register(context, SHEPHERD_1_BLACK_WOOL_EMERALD, VillagerTrades.createShepherdWoolBuy(Items.WOOL.black()));
    }

    private static VillagerTrade createShepherdWoolBuy(Item item) {
        return new VillagerTrade(new TradeCost((ItemLike)item, 18), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05f, Optional.empty(), List.of());
    }

    private static void registerShepherdLevelTwoDyeTrades(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.register(context, SHEPHERD_2_WHITE_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.white(), 10));
        VillagerTrades.register(context, SHEPHERD_2_GRAY_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.gray(), 10));
        VillagerTrades.register(context, SHEPHERD_2_BLACK_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.black(), 10));
        VillagerTrades.register(context, SHEPHERD_2_LIGHT_BLUE_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.lightBlue(), 10));
        VillagerTrades.register(context, SHEPHERD_2_LIME_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.lime(), 10));
    }

    private static void registerShepherdLevelThreeDyeTrades(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.register(context, SHEPHERD_3_YELLOW_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.yellow(), 20));
        VillagerTrades.register(context, SHEPHERD_3_LIGHT_GRAY_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.lightGray(), 20));
        VillagerTrades.register(context, SHEPHERD_3_ORANGE_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.orange(), 20));
        VillagerTrades.register(context, SHEPHERD_3_RED_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.red(), 20));
        VillagerTrades.register(context, SHEPHERD_3_PINK_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.pink(), 20));
    }

    private static void registerLevelFourDyeTrades(BootstrapContext<VillagerTrade> context) {
        VillagerTrades.register(context, SHEPHERD_4_BROWN_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.brown(), 30));
        VillagerTrades.register(context, SHEPHERD_4_PURPLE_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.purple(), 30));
        VillagerTrades.register(context, SHEPHERD_4_BLUE_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.blue(), 30));
        VillagerTrades.register(context, SHEPHERD_4_GREEN_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.green(), 30));
        VillagerTrades.register(context, SHEPHERD_4_MAGENTA_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.magenta(), 30));
        VillagerTrades.register(context, SHEPHERD_4_CYAN_DYE_EMERALD, VillagerTrades.createShepherdDyeBuy(Items.DYE.cyan(), 30));
    }

    private static VillagerTrade createShepherdDyeBuy(Item item, int xp) {
        return new VillagerTrade(new TradeCost((ItemLike)item, 12), new ItemStackTemplate(Items.EMERALD), 16, xp, 0.05f, Optional.empty(), List.of());
    }

    private static void registerWoolPurchases(BootstrapContext<VillagerTrade> context) {
        ColorCollection.zipApply(SHEPHERD_2_EMERALD_WOOL, Items.WOOL, (name, wool) -> VillagerTrades.register(context, name, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate((Item)wool), 16, 5, 0.05f, Optional.empty(), List.of())));
    }

    private static void registerCarpetPurchases(BootstrapContext<VillagerTrade> context) {
        ColorCollection.zipApply(SHEPHERD_2_EMERALD_CARPETS, Items.CARPET, (name, carpet) -> VillagerTrades.register(context, name, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 1), new ItemStackTemplate((Item)carpet, 4), 16, 5, 0.05f, Optional.empty(), List.of())));
    }

    private static void registerBedTrades(BootstrapContext<VillagerTrade> context) {
        ColorCollection.zipApply(SHEPHERD_3_EMERALD_BED, Items.BED, (name, bed) -> VillagerTrades.register(context, name, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate((Item)bed), 12, 10, 0.05f, Optional.empty(), List.of())));
    }

    private static void registerShepherdBannerTrades(BootstrapContext<VillagerTrade> context) {
        ColorCollection.zipApply(SHEPHERD_4_EMERALD_BANNER, Items.BANNER, (name, banner) -> VillagerTrades.register(context, name, new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 3), new ItemStackTemplate((Item)banner), 12, 15, 0.05f, Optional.empty(), List.of())));
    }
    ...
    private static void registerCartographerBannerTrades(BootstrapContext<VillagerTrade> context, HolderGetter<VillagerType> villagerVariants) {
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_WHITE_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.white(), List.of(VillagerType.SNOW, VillagerType.PLAINS)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_ORANGE_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.orange(), List.of(VillagerType.SAVANNA, VillagerType.DESERT)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_MAGENTA_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.magenta(), List.of(VillagerType.SAVANNA)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_BLUE_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.blue(), List.of(VillagerType.SNOW, VillagerType.TAIGA)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_LIGHT_BLUE_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.lightBlue(), List.of(VillagerType.SNOW, VillagerType.SWAMP)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_YELLOW_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.yellow(), List.of(VillagerType.PLAINS, VillagerType.JUNGLE)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_LIME_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.lime(), List.of(VillagerType.DESERT, VillagerType.TAIGA)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_PINK_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.pink(), List.of(VillagerType.TAIGA, VillagerType.PLAINS)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_GRAY_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.gray(), List.of(VillagerType.DESERT)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_CYAN_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.cyan(), List.of(VillagerType.DESERT, VillagerType.SNOW)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_PURPLE_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.purple(), List.of(VillagerType.TAIGA, VillagerType.SWAMP)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_BROWN_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.brown(), List.of(VillagerType.PLAINS, VillagerType.JUNGLE)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_GREEN_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.green(), List.of(VillagerType.DESERT, VillagerType.SAVANNA, VillagerType.JUNGLE)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_RED_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.red(), List.of(VillagerType.SNOW, VillagerType.SAVANNA)));
        VillagerTrades.register(context, CARTOGRAPHER_4_EMERALD_BLACK_BANNER, VillagerTrades.createCartographerBannerSell(villagerVariants, Items.BANNER.black(), List.of(VillagerType.SWAMP)));
    }
    ...
    private static VillagerTrade createCartographerBannerSell(HolderGetter<VillagerType> villagerVariants, Item item, List<ResourceKey<VillagerType>> villagerTypes) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 2), new ItemStackTemplate(item), 12, 15, 0.05f, VillagerTrades.villagerTypeRestriction(VillagerTrades.villagerTypeHolderSet(villagerVariants, villagerTypes)), List.of());
    }
    ...
    private static void registerBasicExplorerMapTrades(BootstrapContext<VillagerTrade> context, HolderGetter<Item> items, HolderGetter<VillagerType> villagerVariants) {
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_VILLAGE_TAIGA_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_TAIGA_VILLAGE_MAPS, MapDecorationTypes.TAIGA_VILLAGE, "village_taiga", List.of(VillagerType.SWAMP, VillagerType.SNOW, VillagerType.PLAINS)));
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_EXPLORER_SWAMP_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_SWAMP_EXPLORER_MAPS, MapDecorationTypes.SWAMP_HUT, "explorer_swamp", List.of(VillagerType.TAIGA, VillagerType.SNOW, VillagerType.JUNGLE)));
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_VILLAGE_SNOWY_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_SNOWY_VILLAGE_MAPS, MapDecorationTypes.SNOWY_VILLAGE, "village_snowy", List.of(VillagerType.TAIGA, VillagerType.SWAMP)));
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_VILLAGE_SAVANNA_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_SAVANNA_VILLAGE_MAPS, MapDecorationTypes.SAVANNA_VILLAGE, "village_savanna", List.of(VillagerType.PLAINS, VillagerType.JUNGLE, VillagerType.DESERT)));
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_VILLAGE_PLAINS_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_PLAINS_VILLAGE_MAPS, MapDecorationTypes.PLAINS_VILLAGE, "village_plains", List.of(VillagerType.TAIGA, VillagerType.SNOW, VillagerType.SAVANNA, VillagerType.DESERT)));
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_EXPLORER_JUNGLE_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_JUNGLE_EXPLORER_MAPS, MapDecorationTypes.JUNGLE_TEMPLE, "explorer_jungle", List.of(VillagerType.SWAMP, VillagerType.SAVANNA, VillagerType.DESERT)));
        VillagerTrades.register(context, CARTOGRAPHER_2_EMERALD_AND_COMPASS_VILLAGE_DESERT_MAP, VillagerTrades.createBasicExplorerMapTrades(items, villagerVariants, StructureTags.ON_DESERT_VILLAGE_MAPS, MapDecorationTypes.DESERT_VILLAGE, "village_desert", List.of(VillagerType.SAVANNA, VillagerType.JUNGLE)));
    }
    ...
    private static VillagerTrade createBasicExplorerMapTrades(HolderGetter<Item> items, HolderGetter<VillagerType> villagerVariants, TagKey<Structure> structureTagKey, Holder<MapDecorationType> mapDecorationType, String translationKey, List<ResourceKey<VillagerType>> villagerTypes) {
        return new VillagerTrade(new TradeCost((ItemLike)Items.EMERALD, 8), Optional.of(new TradeCost((ItemLike)Items.COMPASS, 1)), new ItemStackTemplate(Items.MAP), 12, 5, 0.2f, VillagerTrades.villagerTypeRestriction(VillagerTrades.villagerTypeHolderSet(villagerVariants, villagerTypes)), List.of(ExplorationMapFunction.makeExplorationMap().setDestination(structureTagKey).setMapDecoration(mapDecorationType).setSearchRadius(100).setSkipKnownStructures(true).build(), SetNameFunction.setName(Component.translatable("filled_map." + translationKey), SetNameFunction.Target.ITEM_NAME).build(), FilteredFunction.filtered(new ItemPredicate.Builder().of(items, Items.FILLED_MAP).withComponents(DataComponentMatchers.Builder.components().any(DataComponents.MAP_ID).build()).build()).onFail(Optional.of(DiscardItem.discardItem().build())).build()));
    }
