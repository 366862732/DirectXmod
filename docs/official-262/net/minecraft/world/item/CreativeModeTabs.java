...
public class CreativeModeTabs {
    ...
    private static @Nullable CreativeModeTab.ItemDisplayParameters CACHED_PARAMETERS;
    ...
    public static CreativeModeTab bootstrap(Registry<CreativeModeTab> registry) {
        Registry.register(registry, BUILDING_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0).title(Component.translatable("itemGroup.buildingBlocks")).icon(() -> new ItemStack(Blocks.BRICKS)).displayItems((parameters, buildingBlocks) -> {
            ...
            CreativeModeTabs.copperBlockFamilies(family -> family.weathering().forEach(buildingBlocks::accept));
            CreativeModeTabs.copperBlockFamilies(family -> family.waxed().forEach(buildingBlocks::accept));
        }).build());
        ...
        Registry.register(registry, COLORED_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.coloredBlocks")).icon(() -> new ItemStack(Blocks.WOOL.cyan())).displayItems((parameters, coloredBlocks) -> {
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.WOOL);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.CARPET);
            coloredBlocks.accept(Items.TERRACOTTA);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.DYED_TERRACOTTA);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.CONCRETE);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.CONCRETE_POWDER);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.GLAZED_TERRACOTTA);
            coloredBlocks.accept(Items.GLASS);
            coloredBlocks.accept(Items.TINTED_GLASS);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.STAINED_GLASS);
            coloredBlocks.accept(Items.GLASS_PANE);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.STAINED_GLASS_PANE);
            coloredBlocks.accept(Items.SHULKER_BOX);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.DYED_SHULKER_BOX);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.BED);
            coloredBlocks.accept(Items.CANDLE);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.DYED_CANDLE);
            CreativeModeTabs.registerColoredItems(coloredBlocks, gameplayColorOrder, Items.BANNER);
        }).build());
        Registry.register(registry, NATURAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 2).title(Component.translatable("itemGroup.natural")).icon(() -> new ItemStack(Blocks.GRASS_BLOCK)).displayItems((parameters, naturalBlocks) -> {
        ...
        Registry.register(registry, FUNCTIONAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 3).title(Component.translatable("itemGroup.functional")).icon(() -> new ItemStack(Items.OAK_SIGN)).displayItems((parameters, functionalBlocks) -> {
            ...
            parameters.holders().lookup(Registries.PAINTING_VARIANT).ifPresent(paintings -> CreativeModeTabs.generatePresetPaintings(functionalBlocks, parameters.holders(), paintings, variant -> variant.is(PaintingVariantTags.PLACEABLE), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS));
            ...
            CreativeModeTabs.registerColoredItems(functionalBlocks, gameplayColorOrder, Items.DYED_SHULKER_BOX);
            functionalBlocks.accept(Items.RESPAWN_ANCHOR);
            CreativeModeTabs.registerColoredItems(functionalBlocks, gameplayColorOrder, Items.BED);
            functionalBlocks.accept(Items.CANDLE);
            CreativeModeTabs.registerColoredItems(functionalBlocks, gameplayColorOrder, Items.DYED_CANDLE);
            CreativeModeTabs.registerColoredItems(functionalBlocks, gameplayColorOrder, Items.BANNER);
        ...
        Registry.register(registry, REDSTONE_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 4).title(Component.translatable("itemGroup.redstone")).icon(() -> new ItemStack(Items.REDSTONE)).displayItems((parameters, redstoneBlocks) -> {
        ...
        Registry.register(registry, SEARCH, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 6).title(Component.translatable("itemGroup.search")).icon(() -> new ItemStack(Items.COMPASS)).displayItems((parameters, search) -> {
        ...
        Registry.register(registry, TOOLS_AND_UTILITIES, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 0).title(Component.translatable("itemGroup.tools")).icon(() -> new ItemStack(Items.DIAMOND_PICKAXE)).displayItems((parameters, toolsAndUtilities) -> {
            ...
            CreativeModeTabs.generateFireworksAllDurations(toolsAndUtilities, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            ...
            parameters.holders().lookup(Registries.INSTRUMENT).ifPresent(instruments -> CreativeModeTabs.generateInstrumentTypes(toolsAndUtilities, instruments, Items.GOAT_HORN, InstrumentTags.GOAT_HORNS, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS));
        ...
        Registry.register(registry, COMBAT, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 1).title(Component.translatable("itemGroup.combat")).icon(() -> new ItemStack(Items.NETHERITE_SWORD)).displayItems((parameters, combat) -> {
            ...
            CreativeModeTabs.generateFireworksAllDurations(combat, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            combat.accept(Items.ARROW);
            combat.accept(Items.SPECTRAL_ARROW);
            parameters.holders().lookup(Registries.POTION).ifPresent(potions -> CreativeModeTabs.generatePotionEffectTypes(combat, potions, Items.TIPPED_ARROW, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, parameters.enabledFeatures()));
        }).build());
        Registry.register(registry, FOOD_AND_DRINKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 2).title(Component.translatable("itemGroup.foodAndDrink")).icon(() -> new ItemStack(Items.GOLDEN_APPLE)).displayItems((parameters, consumables) -> {
            ...
            CreativeModeTabs.generateSuspiciousStews(consumables, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            consumables.accept(Items.MILK_BUCKET);
            consumables.accept(Items.HONEY_BOTTLE);
            CreativeModeTabs.generateOminousBottles(consumables, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            parameters.holders().lookup(Registries.POTION).ifPresent(potions -> {
                CreativeModeTabs.generatePotionEffectTypes(consumables, potions, Items.POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, parameters.enabledFeatures());
                CreativeModeTabs.generatePotionEffectTypes(consumables, potions, Items.SPLASH_POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, parameters.enabledFeatures());
                CreativeModeTabs.generatePotionEffectTypes(consumables, potions, Items.LINGERING_POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, parameters.enabledFeatures());
            });
        }).build());
        Registry.register(registry, INGREDIENTS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3).title(Component.translatable("itemGroup.ingredients")).icon(() -> new ItemStack(Items.IRON_INGOT)).displayItems((parameters, ingredients) -> {
            ...
            parameters.holders().lookup(Registries.ENCHANTMENT).ifPresent(enchantments -> {
                CreativeModeTabs.generateEnchantmentBookTypesOnlyMaxLevel(ingredients, enchantments, CreativeModeTab.TabVisibility.PARENT_TAB_ONLY);
                CreativeModeTabs.generateEnchantmentBookTypesAllLevels(ingredients, enchantments, CreativeModeTab.TabVisibility.SEARCH_TAB_ONLY);
            });
        }).build());
        Registry.register(registry, SPAWN_EGGS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4).title(Component.translatable("itemGroup.spawnEggs")).icon(() -> new ItemStack(Items.CREEPER_SPAWN_EGG)).displayItems((parameters, spawnEggs) -> {
        ...
        Registry.register(registry, OP_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 5).title(Component.translatable("itemGroup.op")).icon(() -> new ItemStack(Items.COMMAND_BLOCK)).alignedRight().displayItems((parameters, opBlocks) -> {
            if (parameters.hasPermissions()) {
                ...
                parameters.holders().lookup(Registries.PAINTING_VARIANT).ifPresent(paintings -> CreativeModeTabs.generatePresetPaintings(opBlocks, parameters.holders(), paintings, variant -> !variant.is(PaintingVariantTags.PLACEABLE), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS));
            }
        }).build());
        return Registry.register(registry, INVENTORY, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 6).title(Component.translatable("itemGroup.inventory")).icon(() -> new ItemStack(Blocks.CHEST)).backgroundTexture(INVENTORY_BACKGROUND).hideTitle().alignedRight().type(CreativeModeTab.Type.INVENTORY).noScrollBar().build());
    }

    private static void registerColoredItems(CreativeModeTab.Output coloredBlocks, List<DyeColor> gameplayColorOrder, ColorCollection<Item> items) {
        gameplayColorOrder.forEach(color -> coloredBlocks.accept((ItemLike)items.pick((DyeColor)color)));
    }

    public static void validate() {
        HashMap<Pair, String> positions = new HashMap<Pair, String>();
        for (ResourceKey<CreativeModeTab> tabKey : BuiltInRegistries.CREATIVE_MODE_TAB.registryKeySet()) {
            ...
            String previous = positions.put(Pair.of((Object)((Object)tab.row()), (Object)tab.column()), current);
    ...
    private static void generatePotionEffectTypes(CreativeModeTab.Output output, HolderLookup<Potion> potions, Item item, CreativeModeTab.TabVisibility tabVisibility, FeatureFlagSet enabledFeatures) {
        potions.listElements().filter(potion -> ((Potion)potion.value()).isEnabled(enabledFeatures)).map(potion -> PotionContents.createItemStack(item, potion)).forEach(stack -> output.accept((ItemStack)stack, tabVisibility));
    }
    ...
    private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output output, HolderLookup<Enchantment> enchantments, CreativeModeTab.TabVisibility tabVisibility) {
        enchantments.listElements().map(enchantment -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder<Enchantment>)enchantment, ((Enchantment)enchantment.value()).getMaxLevel()))).forEach(stack -> output.accept((ItemStack)stack, tabVisibility));
    }
    ...
    private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output output, HolderLookup<Enchantment> enchantments, CreativeModeTab.TabVisibility tabVisibility) {
        enchantments.listElements().flatMap(enchantment -> IntStream.rangeClosed(((Enchantment)enchantment.value()).getMinLevel(), ((Enchantment)enchantment.value()).getMaxLevel()).mapToObj(level -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder<Enchantment>)enchantment, level)))).forEach(stack -> output.accept((ItemStack)stack, tabVisibility));
    }
    ...
    private static void generateInstrumentTypes(CreativeModeTab.Output output, HolderLookup<Instrument> instruments, Item instrumentItem, TagKey<Instrument> instrumentTagKey, CreativeModeTab.TabVisibility tabVisibility) {
        instruments.get(instrumentTagKey).ifPresent(tag -> tag.stream().map(instrument -> InstrumentItem.create(instrumentItem, instrument)).forEach(stack -> output.accept((ItemStack)stack, tabVisibility)));
    }
    ...
    private static void copperBlockFamilies(Consumer<WeatheringCopperCollection<Item>> output) {
    ...
    private static void buildAllTabContents(CreativeModeTab.ItemDisplayParameters parameters) {
        CreativeModeTabs.streamAllTabs().filter(tab -> tab.getType() == CreativeModeTab.Type.CATEGORY).forEach(tab -> tab.buildContents(parameters));
        CreativeModeTabs.streamAllTabs().filter(tab -> tab.getType() != CreativeModeTab.Type.CATEGORY).forEach(tab -> tab.buildContents(parameters));
    }
