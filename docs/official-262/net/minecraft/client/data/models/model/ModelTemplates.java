...
public class ModelTemplates {
    ...
    public static final ModelTemplate SIGN_ROT_0 = ModelTemplates.create("template_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SIGN_ROT_1 = ModelTemplates.create("template_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SIGN_ROT_2 = ModelTemplates.create("template_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SIGN_ROT_3 = ModelTemplates.create("template_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate WALL_SIGN = ModelTemplates.create("template_wall_sign", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate HANGING_SIGN_ROT_0 = ModelTemplates.create("template_hanging_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate HANGING_SIGN_ROT_1 = ModelTemplates.create("template_hanging_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate HANGING_SIGN_ROT_2 = ModelTemplates.create("template_hanging_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate HANGING_SIGN_ROT_3 = ModelTemplates.create("template_hanging_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_0 = ModelTemplates.create("template_attached_hanging_sign_rot_0", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_1 = ModelTemplates.create("template_attached_hanging_sign_rot_1", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_2 = ModelTemplates.create("template_attached_hanging_sign_rot_2", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate ATTACHED_HANGING_SIGN_ROT_3 = ModelTemplates.create("template_attached_hanging_sign_rot_3", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate WALL_HANGING_SIGN = ModelTemplates.create("template_wall_hanging_sign", TextureSlot.ALL, TextureSlot.PARTICLE);
    ...
    public static final ModelTemplate BED_HEAD = ModelTemplates.create("template_bed_head", TextureSlot.UP, TextureSlot.EAST, TextureSlot.WEST);
    public static final ModelTemplate BED_FOOT = ModelTemplates.create("template_bed_foot", TextureSlot.UP, TextureSlot.EAST, TextureSlot.WEST, TextureSlot.SOUTH);
    ...
    public static final ModelTemplate SHELF_BODY = ModelTemplates.create("template_shelf_body", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SHELF_INVENTORY = ModelTemplates.create("template_shelf_inventory", "_inventory", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SHELF_UNPOWERED = ModelTemplates.create("template_shelf_unpowered", "_unpowered", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SHELF_UNCONNECTED = ModelTemplates.create("template_shelf_unconnected", "_unconnected", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SHELF_LEFT = ModelTemplates.create("template_shelf_left", "_left", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SHELF_CENTER = ModelTemplates.create("template_shelf_center", "_center", TextureSlot.ALL, TextureSlot.PARTICLE);
    public static final ModelTemplate SHELF_RIGHT = ModelTemplates.create("template_shelf_right", "_right", TextureSlot.ALL, TextureSlot.PARTICLE);
    ...
    public static final ModelTemplate CHAIN = ModelTemplates.create("template_chain", TextureSlot.TEXTURE);
    public static final ModelTemplate BARS_CAP = ModelTemplates.create("template_bars_cap", "_cap", TextureSlot.BARS, TextureSlot.EDGE);
    public static final ModelTemplate BARS_CAP_ALT = ModelTemplates.create("template_bars_cap_alt", "_cap_alt", TextureSlot.BARS, TextureSlot.EDGE);
    public static final ModelTemplate BARS_POST = ModelTemplates.create("template_bars_post", "_post", TextureSlot.BARS, TextureSlot.EDGE);
    public static final ModelTemplate BARS_POST_ENDS = ModelTemplates.create("template_bars_post_ends", "_post_ends", TextureSlot.BARS, TextureSlot.EDGE);
    public static final ModelTemplate BARS_POST_SIDE = ModelTemplates.create("template_bars_side", "_side", TextureSlot.BARS, TextureSlot.EDGE);
    public static final ModelTemplate BARS_POST_SIDE_ALT = ModelTemplates.create("template_bars_side_alt", "_side_alt", TextureSlot.BARS, TextureSlot.EDGE);
    ...
    public static final ModelTemplate SPEAR_IN_HAND = ModelTemplates.createItem("spear_in_hand", "_in_hand", TextureSlot.LAYER0);
    ...
    public static final ModelTemplate LIGHTNING_ROD = ModelTemplates.create("template_lightning_rod", TextureSlot.TEXTURE);
