...
implements MetricsSamplerProvider {
    ...
    private void registerStaticSamplers() {
        ...
        if (sectionRenderDispatcher != null) {
            this.samplers.add(MetricSampler.createExtractSampler("freeBufferCount", MetricCategory.CHUNK_RENDERING_DISPATCHING, sectionRenderDispatcher::getFreeBufferCount));
            this.samplers.add(MetricSampler.createExtractSampler("compileQueueSize", MetricCategory.CHUNK_RENDERING_DISPATCHING, sectionRenderDispatcher::getCompileQueueSize));
        }
