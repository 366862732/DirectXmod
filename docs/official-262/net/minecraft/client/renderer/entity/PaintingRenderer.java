        ...
        submitNodeCollector.submitCustomGeometry(poseStack, renderType, (pose, buffer) -> {
            ...
            for (int segmentX = 0; segmentX < width; ++segmentX) {
                for (int segmentY = 0; segmentY < height; ++segmentY) {
                    ...
                    PaintingRenderer.vertex(pose, buffer, x0, y1, frontU1, frontV0, -0.03125f, 0, 0, -1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y1, frontU0, frontV0, -0.03125f, 0, 0, -1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y0, frontU0, frontV1, -0.03125f, 0, 0, -1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x0, y0, frontU1, frontV1, -0.03125f, 0, 0, -1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x0, y0, backU1, backV0, 0.03125f, 0, 0, 1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y0, backU0, backV0, 0.03125f, 0, 0, 1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y1, backU0, backV1, 0.03125f, 0, 0, 1, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x0, y1, backU1, backV1, 0.03125f, 0, 0, 1, lightCoords);
                    if (segmentY == height - 1) {
                        PaintingRenderer.vertex(pose, buffer, x0, y0, topBottomU0, topBottomV0, -0.03125f, 0, 1, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x1, y0, topBottomU1, topBottomV0, -0.03125f, 0, 1, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x1, y0, topBottomU1, topBottomV1, 0.03125f, 0, 1, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x0, y0, topBottomU0, topBottomV1, 0.03125f, 0, 1, 0, lightCoords);
                    }
                    if (segmentY == 0) {
                        PaintingRenderer.vertex(pose, buffer, x0, y1, topBottomU0, topBottomV0, 0.03125f, 0, -1, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x1, y1, topBottomU1, topBottomV0, 0.03125f, 0, -1, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x1, y1, topBottomU1, topBottomV1, -0.03125f, 0, -1, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x0, y1, topBottomU0, topBottomV1, -0.03125f, 0, -1, 0, lightCoords);
                    }
                    if (segmentX == width - 1) {
                        PaintingRenderer.vertex(pose, buffer, x0, y0, leftRightU1, leftRightV0, 0.03125f, -1, 0, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x0, y1, leftRightU1, leftRightV1, 0.03125f, -1, 0, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x0, y1, leftRightU0, leftRightV1, -0.03125f, -1, 0, 0, lightCoords);
                        PaintingRenderer.vertex(pose, buffer, x0, y0, leftRightU0, leftRightV0, -0.03125f, -1, 0, 0, lightCoords);
                    }
                    if (segmentX != 0) continue;
                    PaintingRenderer.vertex(pose, buffer, x1, y0, leftRightU1, leftRightV0, -0.03125f, 1, 0, 0, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y1, leftRightU1, leftRightV1, -0.03125f, 1, 0, 0, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y1, leftRightU0, leftRightV1, 0.03125f, 1, 0, 0, lightCoords);
                    PaintingRenderer.vertex(pose, buffer, x1, y0, leftRightU0, leftRightV0, 0.03125f, 1, 0, 0, lightCoords);
                }
            }
        });
    }
