...
public class RenderTypes {
    ...
    private static final RenderType SOLID_MOVING_BLOCK = RenderType.create("solid_moving_block", RenderTypes.createMovingBlockSetup(RenderPipelines.SOLID_BLOCK, false));
    private static final RenderType CUTOUT_MOVING_BLOCK = RenderType.create("cutout_moving_block", RenderTypes.createMovingBlockSetup(RenderPipelines.CUTOUT_BLOCK, false));
    private static final RenderType TRANSLUCENT_MOVING_BLOCK = RenderType.create("translucent_moving_block", RenderTypes.createMovingBlockSetup(RenderPipelines.TRANSLUCENT_BLOCK, true));
    ...
    private static final Function<Identifier, RenderType> ITEM_CUTOUT = Util.memoize(texture -> {
        RenderSetup state = RenderSetup.builder(RenderPipelines.ITEM_CUTOUT).withTexture("Sampler0", (Identifier)texture).useLightmap().useOverlay().affectsCrumbling().setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE).createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> ITEM_TRANSLUCENT = Util.memoize(texture -> {
        RenderSetup state = RenderSetup.builder(RenderPipelines.ITEM_TRANSLUCENT).withTexture("Sampler0", (Identifier)texture).setOutputTarget(OutputTarget.ITEM_ENTITY_TARGET).useLightmap().useOverlay().affectsCrumbling().sortOnUpload().setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE).createRenderSetup();
    ...
    private static final Function<Identifier, RenderType> BANNER_PATTERN = Util.memoize(texture -> {
        RenderSetup state = RenderSetup.builder(RenderPipelines.BANNER_PATTERN).withTexture("Sampler0", (Identifier)texture).useLightmap().sortOnUpload().createRenderSetup();
    ...
    private static final RenderType GLINT_TRANSLUCENT = RenderType.create("glint_translucent", RenderSetup.builder(RenderPipelines.GLINT).withTexture("Sampler0", ItemFeatureRenderer.ENCHANTED_GLINT_ITEM).setTextureTransform(TextureTransform.GLINT_TEXTURING).setOutputTarget(OutputTarget.ITEM_ENTITY_TARGET).createRenderSetup());
    private static final RenderType GLINT = RenderType.create("glint", RenderSetup.builder(RenderPipelines.GLINT).withTexture("Sampler0", ItemFeatureRenderer.ENCHANTED_GLINT_ITEM).setTextureTransform(TextureTransform.GLINT_TEXTURING).createRenderSetup());
    private static final RenderType ENTITY_GLINT = RenderType.create("entity_glint", RenderSetup.builder(RenderPipelines.GLINT).withTexture("Sampler0", ItemFeatureRenderer.ENCHANTED_GLINT_ITEM).setTextureTransform(TextureTransform.ENTITY_GLINT_TEXTURING).createRenderSetup());
    ...
    private static final Function<Identifier, RenderType> TEXT = Util.memoize(texture -> RenderType.create("text", RenderSetup.builder(RenderPipelines.TEXT).withTexture("Sampler0", (Identifier)texture).useLightmap().createRenderSetup()));
    ...
    private static final Function<Identifier, RenderType> TEXT_GRAYSCALE = Util.memoize(texture -> RenderType.create("text_grayscale", RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE).withTexture("Sampler0", (Identifier)texture).useLightmap().createRenderSetup()));
    ...
    private static final Function<Identifier, RenderType> TEXT_GRAYSCALE_POLYGON_OFFSET = Util.memoize(texture -> RenderType.create("text_grayscale_polygon_offset", RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE_POLYGON_OFFSET).withTexture("Sampler0", (Identifier)texture).useLightmap().sortOnUpload().createRenderSetup()));
    ...
    private static final Function<Identifier, RenderType> TEXT_GRAYSCALE_SEE_THROUGH = Util.memoize(texture -> RenderType.create("text_grayscale_see_through", RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE_SEE_THROUGH).withTexture("Sampler0", (Identifier)texture).useLightmap().sortOnUpload().createRenderSetup()));
    ...
    private static final RenderType DEBUG_TRIANGLE_FAN = RenderType.create("debug_triangle_fan", RenderSetup.builder(RenderPipelines.DEBUG_TRIANGLE_FAN).createRenderSetup());
    ...
    public static RenderType textGrayscale(Identifier texture) {
    ...
    public static RenderType textGrayscalePolygonOffset(Identifier texture) {
    ...
    public static RenderType textGrayscaleSeeThrough(Identifier texture) {
