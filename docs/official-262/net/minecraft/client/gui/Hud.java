...
public class Hud {
    ...
    private Pair<ContextualInfo, ContextualBar> contextualInfoBar = Pair.of((Object)((Object)ContextualInfo.EMPTY), (Object)ContextualBar.EMPTY);
    ...
    public Hud(Minecraft minecraft) {
        ...
        this.contextualInfoBars = ImmutableMap.of((Object)((Object)ContextualInfo.EMPTY), () -> ContextualBar.EMPTY, (Object)((Object)ContextualInfo.EXPERIENCE), () -> new ExperienceBar(minecraft), (Object)((Object)ContextualInfo.LOCATOR), () -> new LocatorBar(minecraft), (Object)((Object)ContextualInfo.JUMPABLE_VEHICLE), () -> new JumpableVehicleBar(minecraft));
    ...
    private void extractScoreboardSidebar(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        if (playerTeam != null && (teamColor = playerTeam.getColor()).isPresent()) {
    ...
    private void extractEffects(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        for (MobEffectInstance instance : Ordering.natural().reverse().sortedCopy(activeEffects)) {
            ...
            graphics.blitSprite(RenderPipelines.GUI_TEXTURED, Hud.getMobEffectSprite(effect), x + 3, y + 3, 18, 18, ARGB.white(alpha));
        }
    }
    ...
    private void extractHotbarAndDecorations(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        if (nextContextualInfo != this.contextualInfoBar.getFirst()) {
            this.contextualInfoBar = Pair.of((Object)((Object)nextContextualInfo), (Object)this.contextualInfoBars.get((Object)nextContextualInfo).get());
        }
    ...
    private void displayScoreboardSidebar(GuiGraphicsExtractor graphics, Objective objective) {
        ...
        graphics.text(this.getFont(), objectiveDisplayName, left + width / 2 - objectiveDisplayNameWidth / 2, headerY - this.getFont().lineHeight, -1, false);
    ...
    private void extractPlayerHealth(GuiGraphicsExtractor graphics) {
        ...
        Hud.extractArmor(graphics, player, yLineBase, numHealthRows, healthRowHeight, xLeft);
    ...
    private void extractHearts(GuiGraphicsExtractor graphics, Player player, int xLeft, int yLineBase, int healthRowHeight, int heartOffsetIndex, float maxHealth, int currentHealth, int oldHealth, int absorption, boolean blink) {
        ...
        for (int containerIndex = healthContainerCount + absorptionContainerCount - 1; containerIndex >= 0; --containerIndex) {
            ...
            this.extractHeart(graphics, HeartType.CONTAINER, xo, yo, isHardcore, blink, false);
            ...
            if (isAbsorptionHeart && (absorptionHalves = halves - maxHealthHalvesCount) < absorption) {
                ...
                this.extractHeart(graphics, type == HeartType.WITHERED ? type : HeartType.ABSORBING, xo, yo, isHardcore, false, halfHeart2);
            }
    ...
    private void extractHeart(GuiGraphicsExtractor graphics, HeartType type, int xo, int yo, boolean isHardcore, boolean blinks, boolean half) {
    ...
    private void extractAirBubbles(GuiGraphicsExtractor graphics, Player player, int vehicleHearts, int yLineAir, int xRight) {
        ...
        if (isUnderWater || currentAirSupplyTicks < maxAirSupplyTicks) {
            ...
            int fullAirBubbles = Hud.getCurrentAirSupplyBubble(currentAirSupplyTicks, maxAirSupplyTicks, -2);
            int poppingAirBubblePosition = Hud.getCurrentAirSupplyBubble(currentAirSupplyTicks, maxAirSupplyTicks, 0);
            int emptyAirBubbles = 10 - Hud.getCurrentAirSupplyBubble(currentAirSupplyTicks, maxAirSupplyTicks, Hud.getEmptyBubbleDelayDuration(currentAirSupplyTicks, isUnderWater));
