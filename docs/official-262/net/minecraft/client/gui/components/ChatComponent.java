...
public class ChatComponent {
    ...
    private static final Component RESTRICTED_CHAT_MESSAGE_WITH_HOVER = ComponentUtils.mergeStyles(RESTRICTED_CHAT_MESSAGE, Style.EMPTY.withHoverEvent(new HoverEvent.ShowText(Component.translatable("chat_screen.restricted"))));
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, Font font, int ticks, int mouseX, int mouseY, DisplayMode displayMode, boolean changeCursorOnInsertions) {
        ...
        this.extractRenderState(displayMode.foreground ? new DrawingFocusedGraphicsAccess(graphics, font, mouseX, mouseY, changeCursorOnInsertions) : new DrawingBackgroundGraphicsAccess(graphics), graphics.guiHeight(), ticks, displayMode);
    ...
    private void extractRenderState(final ChatGraphicsAccess graphics, int screenHeight, int ticks, DisplayMode displayMode) {
    ...
    public void openScreen(ChatMethod chatMethod, ChatScreen.ChatConstructor<?> chat) {
        this.minecraft.gui.setScreen((Screen)this.createScreen(chatMethod, chat));
    }
