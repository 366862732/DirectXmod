...
extends Screen {
    ...
    protected void init() {
        ...
        Button chatButton = this.layout.addChild(Button.builder(REPORT_CHAT, button -> this.minecraft.gui.setScreen(new ChatReportScreen(this.lastScreen, this.context, this.player.getPlayerId()))).build());
        ...
        this.layout.addChild(Button.builder(REPORT_SKIN, button -> this.minecraft.gui.setScreen(new SkinReportScreen(this.lastScreen, this.context, this.player.getPlayerId(), this.player.getSkinGetter()))).build());
        ...
        ReportPlayerScreen reportPlayerScreen = this;
        this.layout.visitWidgets(x$0 -> reportPlayerScreen.addRenderableWidget(x$0));
