...
extends ObjectSelectionList<Entry> {
    ...
    extends Entry {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float a) {
            graphics.centeredText(this.font, this.text, this.getX() + this.getWidth() / 2, this.getContentYMiddle() - this.font.lineHeight / 2, -1);
        }
    ...
    implements SelectableEntry {
        ...
        public PackEntry(TransferableSelectionList this$0, Minecraft minecraft, TransferableSelectionList parent, PackSelectionModel.Entry pack) {
            TransferableSelectionList transferableSelectionList = this$0;
            Objects.requireNonNull(transferableSelectionList);
            this.this$0 = transferableSelectionList;
            super(this$0);
