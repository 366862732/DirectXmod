...
extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(CycleButton.builder(ServerData.ServerPackStatus::getName, this.serverData.getResourcePackStatus()).withValues((ServerData.ServerPackStatus[])ServerData.ServerPackStatus.values()).create(this.width / 2 - 100, this.height / 4 + 72, 200, 20, Component.translatable("manageServer.resourcePack"), (button, value) -> this.serverData.setResourcePackStatus((ServerData.ServerPackStatus)((Object)value))));
