...
extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if (this.upgrader.getTotalChunks() > 0) {
            ...
            graphics.text(this.font, Component.translatable("optimizeWorld.info.skipped", this.upgrader.getSkipped()), x0, 40 + this.font.lineHeight + 3, -6250336);
            graphics.text(this.font, Component.translatable("optimizeWorld.info.total", this.upgrader.getTotalChunks()), x0, 40 + (this.font.lineHeight + 3) * 2, -6250336);
            int progress = 0;
            ...
            graphics.centeredText(this.font, countStr, this.width / 2, y0 + 2 * this.font.lineHeight + 2, -6250336);
            graphics.centeredText(this.font, progressStr, this.width / 2, y0 + (y1 - y0) / 2 - this.font.lineHeight / 2, -6250336);
        }
    }
}
