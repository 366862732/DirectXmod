...
public class DataFixers {
    ...
    public static CompletableFuture<?> optimize(Set<DSL.TypeReference> typesToOptimize) {
        ...
        ExecutorService executor = Executors.newSingleThreadExecutor(new ThreadFactoryBuilder().setNameFormat("Datafixer Bootstrap #%d").setDaemon(true).setPriority(1).build());
    ...
    private static void addFixers(DataFixerBuilder fixerUpper, FileFixerUpper.Builder fileFixerUpper) {
        ...
        fixerUpper.addFixer((DataFix)new RemoveBlockEntityTagFix(v1451_5, true, Set.of("minecraft:noteblock", "minecraft:flower_pot")));
        ...
        Schema schema14 = fixerUpper.addSchema(4303, SAME_NAMESPACED);
        ...
        Schema schema15 = fixerUpper.addSchema(4305, SAME_NAMESPACED);
        ...
        Schema schema16 = fixerUpper.addSchema(4306, V4306::new);
        fixerUpper.addFixer((DataFix)new ThrownPotionSplitFix((Schema)v4306));
        Schema schema17 = fixerUpper.addSchema(4307, V4307::new);
        fixerUpper.addFixer((DataFix)new TooltipDisplayComponentFix((Schema)v4307));
        Schema schema18 = fixerUpper.addSchema(4309, SAME_NAMESPACED);
        ...
        Schema schema19 = fixerUpper.addSchema(4311, SAME_NAMESPACED);
        ...
        Schema schema20 = fixerUpper.addSchema(4312, V4312::new);
        fixerUpper.addFixer((DataFix)new PlayerEquipmentFix((Schema)v4312));
        Schema schema21 = fixerUpper.addSchema(4314, SAME_NAMESPACED);
        fixerUpper.addFixer((DataFix)new InlineBlockPosFormatFix((Schema)v4314));
        Schema schema22 = fixerUpper.addSchema(4420, V4420::new);
        ...
        Schema schema23 = fixerUpper.addSchema(4421, V4421::new);
        fixerUpper.addFixer((DataFix)new AddNewChoices((Schema)v4421, "Added Happy Ghast", References.ENTITY));
        Schema schema24 = fixerUpper.addSchema(4424, SAME_NAMESPACED);
        ...
        Schema schema25 = fixerUpper.addSchema(4531, V4531::new);
        fixerUpper.addFixer((DataFix)new AddNewChoices((Schema)v4531, "Added Copper Golem", References.ENTITY));
        Schema schema26 = fixerUpper.addSchema(4532, V4532::new);
        ...
        Schema schema31 = fixerUpper.addSchema(4543, V4543::new);
        fixerUpper.addFixer((DataFix)new AddNewChoices((Schema)v4543, "Added Mannequin", References.ENTITY));
        Schema schema32 = fixerUpper.addSchema(4544, SAME_NAMESPACED);
        fixerUpper.addFixer((DataFix)new LegacyWorldBorderFix((Schema)v4544));
        Schema schema33 = fixerUpper.addSchema(4548, SAME_NAMESPACED);
        ...
        Schema schema43 = fixerUpper.addSchema(4766, SAME_NAMESPACED);
        fixerUpper.addFixer((DataFix)new DayTimeToClockFix((Schema)v4766));
        Schema schema44 = fixerUpper.addSchema(4769, SAME_NAMESPACED);
        ...
        Schema schema45 = fixerUpper.addSchema(4771, V4771::new);
        ...
        Schema schema46 = fileFixerUpper.addSchema(fixerUpper, 4772, SAME_NAMESPACED);
        ...
        Schema schema47 = fileFixerUpper.addSchema(fixerUpper, 4773, SAME_NAMESPACED);
        fileFixerUpper.addFixer(new GeneratedStructuresRenameFileFix((Schema)v4773));
        Schema schema48 = fixerUpper.addSchema(4881, V4881::new);
        fixerUpper.addFixer((DataFix)new AddNewChoices((Schema)v4881, "Added Sulfur Cube", References.ENTITY));
        fixerUpper.addFixer((DataFix)new AddNewChoices((Schema)v4881, "Added Potent Sulfur", References.BLOCK_ENTITY));
        Schema schema49 = fixerUpper.addSchema(4882, SAME_NAMESPACED);
        fixerUpper.addFixer((DataFix)new BlendingDataFix((Schema)blendingSchema));
        Schema schema50 = fixerUpper.addSchema(4885, V4885::new);
        fixerUpper.addFixer((DataFix)new RemoveBlockEntityTagFix((Schema)v4885, Set.of("minecraft:bed")));
        Schema schema51 = fixerUpper.addSchema(4888, SAME_NAMESPACED);
        fixerUpper.addFixer((DataFix)new RenameNameplateToNameTagFix((Schema)v4888));
        Schema schema52 = fixerUpper.addSchema(4892, SAME_NAMESPACED);
        fixerUpper.addFixer((DataFix)new OptionsForceDefaultGraphicsApiFix((Schema)v4892));
        Schema schema53 = fileFixerUpper.addSchema(fixerUpper, 4899, SAME_NAMESPACED);
        fileFixerUpper.addFixer(new ReenableSpectatorsGenerateChunksInHardcoreWorldsFileFix((Schema)v4899));
    }
