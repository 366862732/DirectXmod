...
{
    public static final MapCodec<UniformInt> MAP_CODEC = RecordCodecBuilder.mapCodec(i -> i.group((App)Codec.INT.fieldOf("min_inclusive").forGetter(UniformInt::minInclusive), (App)Codec.INT.fieldOf("max_inclusive").forGetter(UniformInt::maxInclusive)).apply((Applicative)i, UniformInt::new)).validate(u -> {
